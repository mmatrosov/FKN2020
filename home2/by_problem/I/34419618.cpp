...
int scalar(const std::vector<int>& coordinates, const std::vector<int>& new_coordinates) {
    int scal = 0;
    for (int i = 0; i < coordinates.size(); i++)
        scal += coordinates[i] * new_coordinates[i];
    return scal;
}
